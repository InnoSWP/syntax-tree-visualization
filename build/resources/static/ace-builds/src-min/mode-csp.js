...
define("ace/mode/csp_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("./text").Mode, i = e("./csp_highlight_rules").CspHighlightRules, s = e("../lib/oop"), o = function () { this.HighlightRules = i; };
    s.inherits(o, r), function () { this.$id = "ace/mode/csp"; }.call(o.prototype), t.Mode = o;
});
(function () {
