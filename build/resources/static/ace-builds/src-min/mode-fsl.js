...
define("ace/mode/fsl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    s.metaData = { fileTypes: ["fsl", "fsl_state"], name: "FSL", scopeName: "source.fsl" }, r.inherits(s, i), t.FSLHighlightRules = s;
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./fsl_highlight_rules").FSLHighlightRules, o = e("./folding/cstyle").FoldMode, u = function () { this.HighlightRules = s, this.foldingRules = new o; };
    r.inherits(u, i), function () { this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.$id = "ace/mode/fsl", this.snippetFileId = "ace/snippets/fsl"; }.call(u.prototype), t.Mode = u;
});
(function () {
