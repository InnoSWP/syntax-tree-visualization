...
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    r.inherits(u, i), function () { this.foldingStartMarker = /\b(function|then|do|repeat)\b|{\s*$|(\[=*\[)/, this.foldingStopMarker = /\bend\b|^\s*}|\]=*\]/, this.getFoldWidget = function (e, t, n) { var r = e.getLine(n), i = this.foldingStartMarker.test(r), s = this.foldingStopMarker.test(r); if (i && !s) {
        ...
        return; var f = a.value, l = [f], c = u[f]; if (!c)
        return; var h = c === -1 ? i.getCurrentTokenColumn() : e.getLine(t).length, p = t; i.step = c === -1 ? i.stepBackward : i.stepForward; while (a = i.step()) {
        if (a.type !== "keyword")
            continue;
        var d = c * u[a.value];
        if (d > 0)
            ...
            l.shift();
            if (!l.length && a.value != "elseif")
                break;
            d === 0 && l.unshift(a.value);
        }
    } if (!a)
        return null; if (r)
        return i.getCurrentTokenRange(); var t = i.getCurrentTokenRow(); return c === -1 ? new s(t, e.getLine(t).length, p, h) : new s(p, h, t, i.getCurrentTokenColumn()); }; }.call(u.prototype);
    ...
    r.inherits(f, i), function () { function n(t) { var n = 0; for (var r = 0; r < t.length; r++) {
        ...
        return !0; var i = this.getTokenizer().getLineTokens(n.trim(), e).tokens; return !i || !i.length ? !1 : i[0].type == "keyword" && t.indexOf(i[0].value) != -1; }, this.getMatching = function (t, n, r) { if (n == undefined) {
        var i = t.selection.lead;
        r = i.column, n = i.row;
    } var s = t.getTokenAt(n, r); if (s && s.value in e)
        return this.foldingRules.luaBlock(t, n, r, !0); }, this.autoOutdent = function (e, t, n) { var r = t.getLine(n), i = r.match(/^\s*/)[0].length; if (!i || !n)
        return; var s = this.getMatching(t, n, i + 1); if (!s || s.start.row == n)
        return; var o = this.$getIndent(t.getLine(s.start.row)); o.length != i && (t.replace(new u(n, 0, n, i), o), t.outdentRows(new u(n + 1, 0, n + 1, 0))); }, this.createWorker = function (e) { var t = new a(["ace"], "ace/mode/lua_worker", "Worker"); return t.attachToDocument(e.getDocument()), t.on("annotate", function (t) { e.setAnnotations(t.data); }), t.on("terminate", function () { e.clearAnnotations(); }), t; }, this.$id = "ace/mode/lua", this.snippetFileId = "ace/snippets/lua"; }.call(f.prototype), t.Mode = f;
