...
ace.define("ace/mode/jssm_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    s.metaData = { fileTypes: ["jssm", "jssm_state"], name: "JSSM", scopeName: "source.jssm" }, r.inherits(s, i), t.JSSMHighlightRules = s;
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./jssm_highlight_rules").JSSMHighlightRules, o = e("./folding/cstyle").FoldMode, u = function () { this.HighlightRules = s, this.foldingRules = new o; };
    r.inherits(u, i), function () { this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.$id = "ace/mode/jssm"; }.call(u.prototype), t.Mode = u;
});
(function () {
