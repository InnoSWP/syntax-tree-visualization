...
ace.define("ace/mode/tex_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./text_highlight_rules").TextHighlightRules, o = e("./tex_highlight_rules").TexHighlightRules, u = e("./matching_brace_outdent").MatchingBraceOutdent, a = function (e) { e ? this.HighlightRules = s : this.HighlightRules = o, this.$outdent = new u, this.$behaviour = this.$defaultBehaviour; };
    r.inherits(a, i), function () { this.lineCommentStart = "%", this.getNextLineIndent = function (e, t, n) { return this.$getIndent(t); }, this.allowAutoInsert = function () { return !1; }, this.$id = "ace/mode/tex", this.snippetFileId = "ace/snippets/tex"; }.call(a.prototype), t.Mode = a;
});
(function () {
