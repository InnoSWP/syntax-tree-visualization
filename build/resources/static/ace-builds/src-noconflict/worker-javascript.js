    ...
    module.exports = (function () {
        ...
        return outer;
                ...
                var JSHINT = (function () {
                    ...
                    extraModules = [], emitter = new events.EventEmitter();
                ...
                Lexer.prototype = {
                        ...
                        switch (char) {
                            ...
                            case "7":
                                ...
                                this.triggerAsync("warning", {
                                    ...
                                    line: this.line,
                                    character: this.char
                                }, checks, function () { return state.isStrict(); });
                                break;
                            case "u":
                    ...
                    nextLine: function (checks) {
                        ...
                        if (char >= 0) {
                            this.triggerAsync("warning", { code: "W125", line: this.line, character: char + 1 }, checks, function () { return true; });
                        }
                        ...
                        if (!this.ignoringLinterErrors && state.option.maxlen &&
                            ...
                            if (shouldTriggerError) {
                                this.triggerAsync("warning", { code: "W101", line: this.line, character: this.input.length }, checks, function () { return true; });
                            }
                        }
                        return true;
                    },
